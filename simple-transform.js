...
// Simple transform without console output
...
// Write a status file
fs.writeFileSync('./transform-status.txt', `Transformed ${transformedFlashcards.length} points successfully at ${new Date().toISOString()}`);
