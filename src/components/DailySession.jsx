    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white">
      <div className="container mx-auto px-4 py-8">        {/* Header */}
        <header className="text-center mb-8">          <button 
            ...
            disabled={isNavigating}            className={`mb-4 text-yellow-400 hover:text-yellow-300 text-sm font-medium flex items-center ${              isNavigating ? 'opacity-50 cursor-not-allowed' : ''
            }`}
